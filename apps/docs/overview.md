...
| **Agentic payments (x402)**     | SDK + contract | Pay HTTP-402 resources from a smart account via a scoped session key, bounded by an on-chain per-token budget — "give your agent a budget, not your keys." See [x402](./x402.md). |
